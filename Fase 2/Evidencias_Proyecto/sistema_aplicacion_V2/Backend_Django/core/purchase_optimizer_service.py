...
class PurchaseOptimizerService:
    ...
    def __init__(self):
        # Los mínimos de pedido ahora se obtienen dinámicamente desde la BD (campo monto_minimo_pedido)
        # El proveedor preferente se obtiene desde el campo es_preferente en la BD
        pass
        ...
        for mapping in mappings:
            try:
                ...
                opciones.append({
                    ...
                    'es_preferente': mapping.proveedor.es_preferente
                })
    ...
    def consolidar_por_proveedor(self, incluir_solo_activas=True):
        ...
        for sug in sugerencias:
            ...
            if prov_nombre not in por_proveedor:
                # Obtener monto mínimo desde la BD
                minimo_proveedor = sug.proveedor_recomendado.monto_minimo_pedido or Decimal('0')

                por_proveedor[prov_nombre] = {
                    'proveedor': sug.proveedor_recomendado,
                    'sugerencias': [],
                    'total': Decimal('0'),
                    'minimo_requerido': minimo_proveedor,
                    'cumple_minimo': False
                }
