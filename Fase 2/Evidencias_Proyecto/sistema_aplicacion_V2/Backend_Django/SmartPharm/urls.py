...
from core.views.etl_views import run_etl_manual, get_etl_logs, get_etl_status, get_etl_progress, get_etl_diagnostic, truncate_tables
...
urlpatterns = [
    ...
    path('api/etl/truncate/', truncate_tables, name='etl_truncate'),
