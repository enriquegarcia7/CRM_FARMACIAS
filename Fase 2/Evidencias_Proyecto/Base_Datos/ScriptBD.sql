-- ============================================================================
-- SMARTPHARM CRM - ESQUEMA DE BASE DE DATOS POSTGRESQL
-- ============================================================================
-- Proyecto: Sistema CRM especializado para farmacias pequeñas
-- Equipo: Enrique García, Daniel Acevedo, Bastian Hartal
-- Fecha: Octubre 2025
-- Versión: 1.0 - MVP
-- ============================================================================

-- CREAR BASE DE DATOS
CREATE DATABASE smartpharm_crm
    WITH 
    ENCODING = 'UTF8'
...
SELECT 
    EXTRACT(MONTH FROM b.fecha_emision) as mes,
    EXTRACT(YEAR FROM b.fecha_emision) as anio,
    CASE 
